                        ...
                        <div class="x_content">
                            ...
                            <form action="/perawatan/store" method="post" novalidate>
                                ...
                                <div class="field item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3 label-align">Kode Perawatan <span
                                            class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" name="kode_perawatan" class="form-control"
                                            value="{{ old('kode_perawatan', $kode_perawatan) }}" readonly required />
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6">
                                        <select name="prioritas" id="prioritas" class="form-control" required>
                                            ...
                                            <option value="Critical" {{ old('prioritas') == 'Critical' ? 'selected' : '' }}>
                                                Critical</option>
                                ...
                                <div class="field item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3 label-align">Mekanik <span
                                            class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6">
